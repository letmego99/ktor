...
class ServletApplicationResponse(val call: ServletApplicationCall, responsePipeline: RespondPipeline, val servletResponse: HttpServletResponse) : BaseApplicationResponse(call, responsePipeline) {
